...
public class SQLCondition {
	...
	/**
	 * <p>Crea un nueva condición.</>
	 * @param newClass condición del modelo.
	 * @param newField Campo.
	 * @param newValue Valor del campo.
	...
	/**
	 * <p>Devuelve la expresi�n a aplicar en la condición.</p>
	 * @return xpresi�n a aplicar en la condición.
	 */
	public SQLExpresion getExpresion() {
		return expresion;
	}
	/**
	 * <p>Establece la expresi�n a aplicar en la condición.</p>
	 * @param newExpresion  expresi�n a aplicar en la condición.
	 */
