...
import com.ogm.persistance.sql.functions.SQLToCharFunction;
/**
 * <p>.</p>
 ...
 */
@Deprecated
public class ToCharFunctionRender extends AbstractRender implements IFunctionRender {
	/**
	...
	public boolean draw(ModelManager modelManager,SQLCondition condition, StringBuilder sqlBuffer) {
		SQLToCharFunction function = (SQLToCharFunction) condition.getFunction();
	...
	public boolean render(ModelManager modelManager,SQLField field, StringBuilder sqlBuffer) {
		SQLToCharFunction function = (SQLToCharFunction) field.getFunction();
