...
public class ModelDefinition {
	...
	/**
	 * <p>A�ade un nuevo campo al modelo.</p>
	 * @param newField campo a a�adir.
	 */
	...
	public String getColumnToAttribute(String column) {
		...
		if (field == null){
			throw new ModelPersistanceException("la columna ["+column+"] no est� mapeado para la clase clase ["+className+"] .");
		}
	...
	/**
	 * <p>Devuelve la definici�n del modelo de la clase <code>clazz</code>.</p>
	 * <p>Este m�todo se utiliza para clases que no mapean a ninguna tabla, pero que se quieren utilizar como
