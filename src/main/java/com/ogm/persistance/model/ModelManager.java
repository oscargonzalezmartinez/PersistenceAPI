 ...
 * as� como el data source provider necesario para acceder a la bbdd.</p>
 * 
...
public class ModelManager {
	...
	/**
	 * <p>Si este dato no es nulo se aplica una paginaci�n obligatoria a todas las consultas.</p>
	 */
	private SQLPagination pagination = null;
	
	/**
	 * <p>Clase que implementa las sql espec�ficas para el motor de bbdd utilizado</p>
	 */
	...
	/**
	 * <p>Gestor de transacciones. S�lo para transacci�n program�tica.</p>
	 */
	private ITransaction transaction = null;

	/**
	 * <p>Devuelve el modelManager que corresponde con la configuraci�n definida en <code>config</code>.<p>
	 * @return  modelManager que corresponde con la configuraci�n definida en <code>config</code>..
	 */
	 ...
	 * <p>Hay que tener en cuenta que se recorre todos los modelmanager para encontrar el modelo
	...
	/**
	 * <p>Contructor privado para evitar instanciaci�n.</p>
	 */
	...
	private void initialMessage() {
		if (log.isInfoEnabled()){
			...
			log.info("** Configuraci�n " + configFile);
			log.info("******************************************");
		}
	}
	
	/**
	 * <p>Inicializa toda la configuraci�n de los mapeos de clases.</p>
	 */
	private void init(){
	...
	private void loadConfig() {
		...
		queriesFile = configuration.getQueriesFile();
		if (log.isInfoEnabled()){
	 ...
	 * <p>Si no hay ninguno definido se lanza la excepci�n de c�digo <code>ErrorMessageID.PE_00020</code>
	 * @return transaction manager definido.
	 * @throws  ModelPersistanceException si no est� definido el transaction manager
	 */
	...
	/**
	 * <p>Marca el incio de una transacci�n.</p>
	 */
	...
	/**
	 * <p>Realiza un commit sobre la transacci�n activa.</p>
	 */
	...
	/**
	 * <p>Realiza un rollback sobre la transacci�n activa.</p>
	 */
	 ...
	 * <p>Es p�blico y est�tico para poder mapear a querys objetos que no mapean directamente una tabla
	 ...
	 * @return Definici�n del modelo del objeto <code>object</code>.
	 */
	 ...
	 * <p>si la clase no está configurada en el entorno actual se lanza una excepci�n
	 * PersistanceException con código de error ErrorMessageID.PE_00018.<p>
	 * @param clazz Clase de la que queremos obtener el modelo.
	 * @return Definici�n del modelo de la clase <code>clazz</code>.
	 */
	 ...
	 * <p>si la clase no está configurada en el entorno actual se lanza una excepci�n
	 * PersistanceException con c�digo de error ErrorMessageID.PE_00018.<p>
	 ...
	 * </ol>
	 * <p>Si alguna de las comprobaciones falla el proceso se detiene y se lanza una excepci�n.</p>
	 * <p>Este es un error muy serio que solo deber�a producirse en fase de desarrollo.</p> 
