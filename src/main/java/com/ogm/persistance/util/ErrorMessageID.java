...
/**
 * <p>Enumerado con los códigos de error del motor de persistencia.</p>
...
public enum ErrorMessageID {
	...
	/**
	 * Error al ejecutar sentencia: código log [{0}].
	 */
	PE_00000,
	/**
	 * Se esperaba un único registro de la tabla {0}.
	 */
	PE_00001,
	/**
	...
	PE_00008,
	/**
	 * El objeto de tipo {0}, con clave primaria {1} no tiene informado ningún campo, 
	 * por lo tanto no se va a ejecutar el UPDATE dinámico.
	 */
	PE_00009,
	/**
	...
	PE_00010,
	/**
	 * Error en validación de modelo de la clase [{0}]. Detalles: {1}. 
	 */
	PE_00011,
	...
	/**
	 * El atributo [{0}] de la clase [{1}] no está mapeado.
	 */
	PE_00013,
	/**
	...
	PE_00014,
	/**
	 * Hay más de un from. Se han de indicar qué campos se quieren recuperar. Query {0}.
	 */
	PE_00015,
	/**
	 * No se ha indicado un modelo de salida de la query, al tener más de una tabla no se puede asignar uno automáticamente: {0}.
	 */
	PE_00016,
	/**
	...
	/**
	 * La clase {0} no está configurada en {1} por lo que no es persistente. 
	 */
	PE_00018,
	...
	/**
	 * La clase [{0}] no se ha podido compilar después de modificar su bytecode.
	 */
	EH_00002 
