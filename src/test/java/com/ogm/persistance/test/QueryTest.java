...
public class QueryTest {
	...
	protected static final Log log =  LogFactory.getLog(QueryTest.class.getName());
		
	@BeforeClass
	public static void setUp() throws Exception {
	
			PropertyConfigurator.configure(QueryTest.class.getResource("/log4j.properties"));
			...
			if (!tables.next()) {
				BufferedReader br = new BufferedReader(new InputStreamReader(QueryTest.class.getResourceAsStream("/testDB.ddl")));
